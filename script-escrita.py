...
while True:
    ...
    if not os.path.exists(f"./{identificador_servidor}.csv"):
        ...
        # Capturando a velocidade de leitura e escrita antes de um segundo
        leitura_escrita_antes = psutil.disk_io_counters()
        ...
        # Capturando a velocidade de leitura e escrita depois de um segundo
        leitura_escrita_depois = psutil.disk_io_counters()
        ...
        latencia_segundos = resposta_api.elapsed.total_seconds()
